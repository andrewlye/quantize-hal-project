...
def load_wizardlm(model_path):
    ...
    from transformers import LlamaTokenizer, LlamaForCausalLM, GenerationConfig, AutoModelForCausalLM, AutoTokenizer, AutoModelForCausalLM

    load_8bit: bool = False
    
    base_model: str = "meta-llama/Llama-2-7b-hf" #decapoda-research/llama-7b-hf" #"lmsys/vicuna-7b-v1.5" #"decapoda-research/llama-13b-hf" # #"WizardLM/WizardLM-13B-V1.2" #"decapoda-research/llama-13b-hf" #"huggyllama/llama-13b"  #"/path/to/WizardLM13B",

    tokenizer = LlamaTokenizer.from_pretrained(base_model, token = "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")
    ...
    model = AutoModelForCausalLM.from_pretrained(base_model, torch_dtype=torch.float16, token = "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")
