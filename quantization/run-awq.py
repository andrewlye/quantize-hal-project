...
parser.add_argument('--cache_dir', default="/scratch/zx22/andrew/quantize-hal-project/cache", help='cache dir')
parser.add_argument('--save_dir', default="/scratch/zx22/andrew/quantize-hal-project/quant-models", help='save dir')
...
quant_path = f'{args.save_dir}/awq/mistral-7b'
